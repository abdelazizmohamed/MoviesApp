...
public class MovieAdapterP extends RecyclerView.Adapter<MovieAdapterP.MyViewHolder> {

    private List<MovieModel> mainModels;
    private Context context;

    public MovieAdapterP(List<MovieModel> mainModels, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.movie_item_p, parent, false);
